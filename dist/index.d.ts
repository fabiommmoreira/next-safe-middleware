...
declare type BuilderConstructorObj = {
    directives?: CspDirectives | CspDirectivesLenient | string;
    reportOnly?: boolean;
};
declare type CspBuilderConstructorParam = BuilderConstructorObj | CspBuilder | string | [string, string];
declare class CspBuilder {
    ...
    hasDirectiveWithPattern(directive: Exclude<keyof CspDirectives, BooleanDirectives>, pattern: RegExp | string): void;
    toHeaderValue(): string;
    toHeaderKeyValue(): [string, string];
    toString(): string;
    ...
    withStrictDynamic(hashesOrNonce: string | string[], fallback?: CspDirectives["script-src"], extendScriptSrc?: boolean): this;
    withStyleHashes(elemHashes?: string[], attrHashes?: string[]): this;
}
...
declare const memoizeInChainCache: <Args extends any[], T>(key: string, f: (ctx: MiddlewareChainContext, ...args: Args) => T | Promise<T>) => (ctx: MiddlewareChainContext) => (...args: Args) => Promise<T>;
declare const memoizeInGlobalCache: <Args extends any[], T>(key: string, f: (...args: Args) => T | Promise<T>) => (...args: Args) => Promise<T>;
